...
import styles from "./styles/heart-icon.module.css";

const OutlinedHeart: FC = () => {
  return (
    <svg
      width="40"
      height="37"
      ...
      className={styles.outlined__heart}
    >
      <path
...
const FilledHeart: FC<{ isLiked?: boolean }> = ({ isLiked }) => {
  const activeStyle = [styles.filled__heart, styles.active].join(" ");
  ...
  return (
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className={isLiked ? activeStyle : styles.filled__heart}
    >
      <path
